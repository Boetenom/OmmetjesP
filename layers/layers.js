...
lyr_Officielewandelroutes_3.set('fieldLabels', {'Naam': 'no label', 'Link': 'hidden field', });
lyr_OnofficielewandelroutesFyzigoenBoetenom_4.set('fieldLabels', {'Naam': 'no label', 'Bron': 'hidden field', 'Afstand': 'hidden field', });
lyr_Onofficielegeschiedeniswandelingen_5.set('fieldLabels', {'Naam': 'no label', 'Afstand': 'hidden field', });
...
lyr_Recreatie_10.set('fieldLabels', {'Naam': 'no label', 'Link': 'hidden field', });
lyr_Horeca_11.set('fieldLabels', {'Naam': 'no label', 'Link': 'hidden field', });
lyr_Bijzonderelocaties_12.set('fieldLabels', {'Naam': 'no label', 'Link 1': 'hidden field', 'Link 2': 'hidden field', });
